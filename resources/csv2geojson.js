...
S(document).ready(function(){
	...
	function Converter(file){
		...
		this.geographies = {'LSOA21CD':{},'LSOA11CD':{},'LSOA01CD':{},'MSOA21CD':{},'MSOA11CD':{},'WD19CD':{},'WD20CD':{},'WD21CD':{},'WD22CD':{},'WD23CD':{},'PCON17CD':{},'LAD19CD':{},'LAD20CD':{},'LAD21CD':{},'LAD23CD':{},'CAUTH21CD':{}};
		this.messages = [];
	...
	Converter.prototype.findGeography = function(callback){
		...
		if(x >= 0 && y >= 0){
			...
			for(var c = 0; c < this.data.fields.title.length; c++){
				...
				}else if(p < 0 && (this.data.fields.title[c].toUpperCase() == "WARD" || this.data.fields.title[c].toUpperCase() == "WD23CD")){
					p = c;
					this.geotype = "WD21CD";
