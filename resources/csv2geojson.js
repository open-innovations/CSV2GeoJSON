...
S(document).ready(function(){
	...
	function Converter(file){
		...
		this.geographies = {'LSOA21CD':{},'LSOA11CD':{},'LSOA01CD':{},'MSOA21CD':{},'MSOA11CD':{},'WD19CD':{},'WD20CD':{},'WD21CD':{},'WD22CD':{},'WD23CD':{},'WD24CD':{},'WD25CD':{},'PCON17CD':{},'LAD19CD':{},'LAD20CD':{},'LAD21CD':{},'LAD23CD':{},'CAUTH21CD':{}};
		this.messages = [];
	...
	Converter.prototype.findGeography = function(callback){
		...
		if(x >= 0 && y >= 0){
			...
			for(var c = 0; c < this.data.fields.title.length; c++){
				...
				}else if(p < 0 && (this.data.fields.title[c].toUpperCase() == "WARD" || this.data.fields.title[c].toUpperCase() == "WD25CD")){
					p = c;
					this.geotype = "WD25CD";
					//this.patterns = [/^E05[0-9]{6}$/]
				}else if(p < 0 && (this.data.fields.title[c].toUpperCase() == "WD24CD")){
					p = c;
					this.geotype = "WD24CD";
				}else if(p < 0 && (this.data.fields.title[c].toUpperCase() == "WD23CD")){
					p = c;
					this.geotype = "WD23CD";
				}else if(p < 0 && (this.data.fields.title[c].toUpperCase() == "WD22CD")){
					p = c;
					this.geotype = "WD22CD";
				}else if(p < 0 && (this.data.fields.title[c].toUpperCase() == "WD21CD")){
					p = c;
					this.geotype = "WD21CD";
				...
				}else if(p < 0 && (this.data.fields.title[c].toUpperCase() == "COMBINED AUTHORITY" || this.data.fields.title[c].toUpperCase() == "CAUTH21CD")){
					p = c;
					this.geotype = "CAUTH21CD";
